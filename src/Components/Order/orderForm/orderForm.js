...
class  orderForm extends Component{
    ...
    render(){
        ...
        <p className="OrderFormHead">Fill Delivery Details</p>
            <form id="orderForm">
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col xs="8" xl="8">
                        <input type="text" value={this.state.rruga} onChange={this.houseHandler} id="rruga"/>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Col xs="8" xl="8">
                        <input type="text" value={this.state.city} onChange={this.landHandler} id="city"/>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs="4" xl="4">
                        ...
                        <Col xs="8" xl="8">
                        <input type="text" value={this.state.postalcode} onChange={this.postalcodeHandler} id="postalcode"/>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs="4" xl="4">
            ...
            <p className="OrderFormNotice">*Pagesa do bëhet sapo të merrni porosinë :) </p>
        </div>
    );
}
}
